from intl_segmenter_py.grapheme import graphemeSegments, splitGraphemes, countGraphemes
from intl_segmenter_py import String
from intl_segmenter_py._grapheme_data import GraphemeCategory
...
splitGraphemes = lambda s: list(map(lambda m: str(m), _api[1](String(s))))
